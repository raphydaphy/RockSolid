...
public class TileElectricPurifier extends MultiTile
{
	...
	public TileEntity provideTileEntity(IWorld world, int x, int y, TileLayer layer)
	{
		return layer == TileLayer.MAIN && this.isMainPos(x, y, world.getState(x, y))
				? new TileEntityElectricPurifier(world, x, y)
				: null;
	}
			...
			AbstractEntityPlayer player)
	{
		...
		TileEntityElectricPurifier tile = world.getTileEntity(main.getX(), main.getY(),
				TileEntityElectricPurifier.class);
			...
			final boolean forceDrop)
	{
		...
		if (!RockBottomAPI.getNet().isClient())
		{
			...
			final TileEntityElectricPurifier tile = world.getTileEntity(main.getX(), main.getY(),
					TileEntityElectricPurifier.class);
			if (tile != null)
			{
