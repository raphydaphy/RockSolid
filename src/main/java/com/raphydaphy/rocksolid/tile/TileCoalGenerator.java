...
public class TileCoalGenerator extends MultiTile
{
	...
	protected ITileRenderer<TileCoalGenerator> createRenderer(final IResourceName name)
	{
			...
			final boolean forceDrop)
	{
		...
		if (!RockBottomAPI.getNet().isClient())
		{
			...
			final TileEntityCoalGenerator tile = world.getTileEntity(main.getX(), main.getY(),
