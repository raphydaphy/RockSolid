...
public class TileEntityElectricBlastFurnace extends TileEntityElectricFurnace
{
	...
	public TileEntityElectricBlastFurnace(IWorld world, int x, int y, TileLayer layer)
	{
	...
	protected void getRecipeAndStart()
	{
		...
		if ((item = this.inventory.get(0)) != null && (recipe = BlastingRecipe.forInput(item)) != null)
		{
