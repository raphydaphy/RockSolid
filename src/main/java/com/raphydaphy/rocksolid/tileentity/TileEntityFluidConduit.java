...
public class TileEntityFluidConduit extends TileEntityConduit<TileEntityFluidConduit>
{
	...
	public TileEntityFluidConduit(final IWorld world, final int x, final int y, TileLayer layer)
	{
		super(TileEntityFluidConduit.class, 5, world, x, y, layer);
	}

	private void tryOutput(String type, int amount, TileEntity inputInv, Pos2 center, ConduitSide side, int inputTank)
	{
		TileEntityFluidConduit outputConduit = world.getTileEntity(center.getX(), center.getY(),
