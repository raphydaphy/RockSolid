...
public class TileEntityRockCrusher extends TileEntityPowered implements IBasicIO
{
	...
	public TileEntityRockCrusher(final IWorld world, final int x, final int y)
	{
	...
	protected boolean tryTickAction()
	{
		...
		if (input != null)
		{
			final RockCrusherRecipe recipe = RockSolidAPI.getRockCrusherRecipe(input);
			if (recipe != null)
			{
	...
	{
		return RockSolidAPI.getRockCrusherRecipe(item) != null;
	}
}