...
public class BucketRenderer<T extends ItemBucket> implements IItemRenderer<T>
{
    ...
    @Override
    public void render(IGameInstance game, IAssetManager manager, Graphics g, ItemBucket item, ItemInstance instance, float x, float y, float scale, Color filter)
    {
    ...
    @Override
    public void renderOnMouseCursor(IGameInstance game, IAssetManager manager, Graphics g, ItemBucket item, ItemInstance instance, float x, float y, float scale, Color filter)
    {
