...
public class BucketRenderer<T extends ItemBucket> implements IItemRenderer<T>
{
	...
	@Override
	public void render(IGameInstance game, IAssetManager manager, IGraphics g, ItemBucket item, ItemInstance instance,
	...
	@Override
	public void renderOnMouseCursor(IGameInstance game, IAssetManager manager, IGraphics g, T item,
