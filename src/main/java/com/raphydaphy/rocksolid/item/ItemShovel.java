...
public class ItemShovel extends ItemBasic
{
    ...
    public ItemShovel(final IResourceName name, final float miningSpeed, final int miningLevel) {
        super(name);
    ...
    public ItemShovel addToolType(final ToolType type, final int level) {
        this.toolTypes.put(type, level);
        return this;
    }
    
    @Override
    protected IItemRenderer<ItemShovel> createRenderer(final IResourceName name) {
        return new ToolRenderer<ItemShovel>(name);
    }
