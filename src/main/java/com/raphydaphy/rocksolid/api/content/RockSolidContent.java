...
public class RockSolidContent
{
	...
	public static final Tile chest = getTile("chest");
	...
	public static final Tile lamp = getTile("lamp");
	...
	public static final Item pickaxeCopper = getItem("pickaxeCopper");
	...
	public static final Item axeWood = getItem("axeWood");
	public static final Item axeRock = getItem("axeRock");
	public static final Item axeCopper = getItem("axeCopper");
	...
	public static final Item shovelWood = getItem("shovelWood");
	public static final Item shovelRock = getItem("shovelRock");
	public static final Item shovelCopper = getItem("shovelCopper");
