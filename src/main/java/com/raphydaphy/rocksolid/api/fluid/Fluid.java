...
public abstract class Fluid extends TileBasic
{
	...
	{
		/*
		 * if (entity.onGround == false) { entity.motionY = -thickness; } if
		 * (entity instanceof AbstractEntityPlayer) { if
		 * (Settings.KEY_JUMP.isDown()) { entity.onGround = true; entity.motionY
		 * += thickness * 3; } }
		 */
	}
