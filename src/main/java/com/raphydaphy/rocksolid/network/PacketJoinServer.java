...
public class PacketJoinServer implements IPacket
{
	...
	public void handle(IGameInstance game, ChannelHandlerContext context)
	{
		...
		if (entityPlayer != null)
		{
			...
			entityPlayer.getInvContainer().addSlot(new PlayerInvSlot(entityPlayer, 2, PlayerInvSlot.LANTERN_FUEL, (instance) -> instance != null && FuelInput.getFuelTime(instance) > 0, 137, 60));
		}
	}
