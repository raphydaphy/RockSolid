...
public class ModRecipies 
{
	public static void init()
	{
		...
		RockSolidAPI.ALLOY_SMELTER_RECIPES.add(new AlloySmelterRecipe(new ItemInstance(ModItems.gritUranium, 3),  new ItemInstance(ModItems.clusterUranium, 1),new ItemInstance(GameContent.ITEM_SLAG, 1), 750));
		...
		RockSolidAPI.ALLOY_SMELTER_RECIPES.add(new AlloySmelterRecipe(new ItemInstance(ModItems.gritIron, 3),  new ItemInstance(GameContent.ITEM_SLAG, 1),new ItemInstance(ModItems.clusterIron, 1), 750));
		RockSolidAPI.ALLOY_SMELTER_RECIPES.add(new AlloySmelterRecipe(new ItemInstance(ModItems.gritMagnesium, 3), new ItemInstance(GameContent.ITEM_SLAG, 1),new ItemInstance(ModItems.clusterMagnesium, 1), 750));
		...
		RockSolidAPI.BLAST_FURNACE_RECIPES.add(new BlastFurnaceRecipe(new ItemInstance(ModItems.ingotImpureTitanium), new ItemInstance(ModTiles.oreRutile, 1), 5000));
		...
		RockBottomAPI.SEPARATOR_RECIPES.add(new SeparatorRecipe(new ItemInstance(ModItems.gritUranium, 2), new ItemInstance(ModItems.clusterUranium), 350, new ItemInstance(GameContent.ITEM_SLAG), 0.5f));
		...
		RockBottomAPI.SMELTER_RECIPES.add(new SmelterRecipe(new ItemInstance(ModItems.ingotUranium), new ItemInstance(ModItems.gritUranium), 300));
		
		// Remove super pickaxe recipe
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.remove(6);
		
		// misc manual crafting recipies
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModTiles.alloySmelter), new ItemInstance[]{new ItemInstance(ModItems.ingotTin, 10),new ItemInstance(GameContent.ITEM_COPPER_INGOT, 10),new ItemInstance(GameContent.TILE_WOOD_BOARDS, 30),new ItemInstance(GameContent.TILE_ROCK, 60)}));
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModTiles.blastFurnace), new ItemInstance[]{new ItemInstance(ModItems.ingotIron, 15), new ItemInstance(ModItems.ingotBronze, 5), new ItemInstance(GameContent.TILE_ROCK, 130), new ItemInstance(GameContent.TILE_WOOD_BOARDS, 40)}));
		
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModTiles.chest), new ItemInstance[]{new ItemInstance(GameContent.TILE_WOOD_BOARDS, 20)}));
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(GameContent.TILE_DOOR), new ItemInstance[]{new ItemInstance(GameContent.TILE_WOOD_BOARDS, 10), new ItemInstance(GameContent.TILE_ROCK, 5)}));
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(GameContent.TILE_LADDER, 4), new ItemInstance[]{new ItemInstance(GameContent.TILE_WOOD_BOARDS, 8), new ItemInstance(GameContent.TILE_ROCK, 4)}));
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModItems.wrench), new ItemInstance[]{new ItemInstance(ModItems.ingotIron, 4), new ItemInstance(ModItems.ingotTin, 2)}));
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModItems.jetpack), new ItemInstance[]{new ItemInstance(ModTiles.constructionBlockSteel, 4), new ItemInstance(ModTiles.constructionBlockTitanium, 2), new ItemInstance(ModItems.ingotImpureTitanium, 5), new ItemInstance(ModItems.ingotSteel, 10), new ItemInstance(ModItems.ingotUranium, 5), new ItemInstance(ModItems.ingotTitanium, 8), new ItemInstance(ModItems.ingotMagnesium, 5), new ItemInstance(GameContent.TILE_ROCK, 50)}));
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModItems.lantern), new ItemInstance[]{new ItemInstance(GameContent.ITEM_GLOW_CLUSTER, 8), new ItemInstance(ModItems.ingotTin, 10), new ItemInstance(GameContent.TILE_WOOD_BOARDS, 20), new ItemInstance(GameContent.TILE_ROCK, 30)}));
		...
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModTiles.allocator, 8), new ItemInstance[]{new ItemInstance(ModItems.ingotIron, 4), new ItemInstance(ModItems.ingotTin, 4), new ItemInstance(GameContent.TILE_ROCK, 10), new ItemInstance(GameContent.TILE_WOOD_BOARDS, 5)}));
		
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModTiles.fluidPump), new ItemInstance[]{new ItemInstance(ModTiles.constructionBlockSteel, 2), new ItemInstance(GameContent.TILE_WOOD_BOARDS, 55), new ItemInstance(GameContent.TILE_ROCK, 50), new ItemInstance(ModTiles.tank, 1), new ItemInstance(ModItems.ingotSteel, 5)}));
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModTiles.electricPurifier), new ItemInstance[]{new ItemInstance(ModTiles.constructionBlockSteel, 2), new ItemInstance(GameContent.TILE_WOOD_BOARDS, 60), new ItemInstance(GameContent.TILE_ROCK, 120), new ItemInstance(ModItems.ingotBronze, 30), new ItemInstance(ModItems.clumpClay, 10)}));
		...
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModTiles.electricSmelter), new ItemInstance[]{new ItemInstance(ModTiles.constructionBlockSteel, 2), new ItemInstance(GameContent.TILE_WOOD_BOARDS, 35), new ItemInstance(GameContent.TILE_ROCK, 80), new ItemInstance(ModItems.ingotBronze, 15), new ItemInstance(ModItems.ingotTin, 10)}));
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModTiles.compressor), new ItemInstance[]{new ItemInstance(ModTiles.constructionBlockSteel, 2), new ItemInstance(GameContent.TILE_WOOD_BOARDS, 55), new ItemInstance(GameContent.TILE_ROCK, 50), new ItemInstance(ModItems.ingotUranium, 15), new ItemInstance(ModItems.ingotMagnesium, 10)}));
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModTiles.charger), new ItemInstance[]{new ItemInstance(ModTiles.constructionBlockSteel, 2), new ItemInstance(GameContent.TILE_WOOD_BOARDS, 35), new ItemInstance(GameContent.TILE_ROCK, 80), new ItemInstance(ModItems.ingotBronze, 25), new ItemInstance(ModItems.ingotTin, 10), new ItemInstance(ModItems.ingotMagnesium, 10)}));
		RockBottomAPI.MANUAL_CONSTRUCTION_RECIPES.add(new BasicRecipe(new ItemInstance(ModTiles.quarry), new ItemInstance[]{new ItemInstance(ModTiles.constructionBlockTitanium, 4),new ItemInstance(ModTiles.constructionBlockSteel, 2), new ItemInstance(GameContent.TILE_WOOD_BOARDS, 150), new ItemInstance(GameContent.TILE_ROCK, 350), new ItemInstance(ModItems.ingotSteel, 15), new ItemInstance(ModItems.ingotTitanium, 10)}));
