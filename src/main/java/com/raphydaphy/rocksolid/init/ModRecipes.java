...
public class ModRecipes
{
	...
	public static void init()
	{
		...
		new AssemblyRecipe(0.5f, new ItemInstance(ModTiles.BATTERY), 85,6, 5).registerAssembly();
		...
		new AssemblyRecipe(0.6f, new ItemInstance(ModTiles.PUMP),40, 4, 8).registerAssembly();
	}
}
