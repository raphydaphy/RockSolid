...
public class GuiAssemblyStation extends GuiContainer {
    ...
    public final void init(IGameInstance game) {
        super.init(game);
        this.scrollMenu = new ComponentMenu(this, -12 + offset, 2, 12, 90, 1, 4, 6, 0, (new BoundBox(0.0D + offset, 0.0D, 22.0D + offset, 94.0D)).add((double) this.x, (double) this.y), ResourceName.intern("gui.compendium.scroll_bar"));
    ...
    private void a(ICompendiumRecipe var1) {
        ...
        if (var1 != null) {
            ...
            this.componentConstruct = new ComponentConstruct(this, var1, true, this.recipe.canConstruct(te.getInvHidden(), var2), () -> {
