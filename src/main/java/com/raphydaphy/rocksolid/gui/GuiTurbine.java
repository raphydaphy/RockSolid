...
public class GuiTurbine extends GuiContainer
{
	...
	public void init(IGameInstance game)
	{
		...
		this.components.add(new ComponentProgressBar(this, 27, 16, 81, 10, ModUtils.ENERGY, false, this.te::getEnergyFullness));

		this.components.add(new ComponentProgressBar(this, 27, 1, 81, 10, Color.gray.getRGB(), false, this.te::getSteamFullness));
	}
