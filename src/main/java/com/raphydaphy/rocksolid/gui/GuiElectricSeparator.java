...
public class GuiElectricSeparator extends GuiContainer
{
    ...
    public void initGui(final IGameInstance game) {
        super.initGui(game);
        this.components.add(new ComponentProgressBar(this, this.guiLeft + 70, this.guiTop + 15, 35, 8, GuiElectricSeparator.PROGRESS_COLOR, false, this.tile::getSmeltPercentage));
