...
public class GuiElectricPurifier extends GuiContainer
{
    ...
    public void initGui(final IGameInstance game) 
    {
        ...
        this.components.add(new ComponentProgressBar(this, this.guiLeft + 60, this.guiTop + 30, 80, 10, RockSolidLib.getFluidColor(tile.getFluidType()), false, this.tile::getFluidTankFullness));
	...
	public void renderOverlay(IGameInstance game, IAssetManager manager, Graphics g)
	{
		...
		{
			RockBottomAPI.getApiHandler().drawHoverInfoAtMouse(game, manager, g, false, 500, new String[]{"Storing " + this.tile.getCurrentEnergy() + "kWh of Energy", "Uses 30kWh per tick"});
		}
		...
		{
			RockBottomAPI.getApiHandler().drawHoverInfoAtMouse(game, manager, g, false, 500, new String[]{"Storing " + this.tile.getCurrentFluid() + "mL of Fluid", "Uses 100mL per operation"});
		}
	}
