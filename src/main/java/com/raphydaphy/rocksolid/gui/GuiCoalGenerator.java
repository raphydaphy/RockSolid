...
public class GuiCoalGenerator extends GuiContainer
{
	...
	public void renderOverlay(IGameInstance game, IAssetManager manager, Graphics g)
	{
		...
		{
			RockBottomAPI.getApiHandler().drawHoverInfoAtMouse(game, manager, g, false, 500, new String[]{"Storing " + this.tile.getCurrentEnergy() + "kWh of Energy", "Produces 30kWh per tick"});
		}
	}
